...
src: |
    _out = ''; _out << "<table>\n"
      for item in list 
    _out << "  <tr>\n    <td>"
    _out << Erubis::XmlHelper.escape_xml( item ); _out << "</td>\n    <td>"
    _out << ( item ).to_s; _out << "</td>\n  </tr>\n"

      end 
    _out << "</table>\n<ul>"
     for item in list ; _out << "<li>"; _out << Erubis::XmlHelper.escape_xml( item ); _out << "</li>";  end ; _out << "</ul>\n"
    _out
output: |
    <table>
      <tr>
